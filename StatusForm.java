...
class StatusForm extends JFrame {
    ...
    private JButton btnBack, btnSearch, btnChange;
    ...
    StatusForm(CustomerCollection customerCollection) {
        ...
        btnSearch.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                ...
                if (index != -1) {
                    ...
                    JOptionPane.showMessageDialog(StatusForm.this, "Customer not found", "Error",
        ...
        btnChange = new JButton("Change Status");
        btnChange.setFont(new Font("Arial", Font.BOLD, 14));
        btnChange.setBackground(new Color(233, 89, 89));
        btnChange.setForeground(Color.WHITE);
        btnChange.setBounds(250, 300, 180, 35);
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (index != -1) {
                    ...
                    if (currentStatus.equals("Processing")) {
                        ...
                        int choice = JOptionPane.showOptionDialog(null, "Please select the option", "Status Options",
                    ...
                    lblStatusx.setText(customer.getStatus());
                    JOptionPane.showMessageDialog(StatusForm.this, "Status updated successfully", "Success",
